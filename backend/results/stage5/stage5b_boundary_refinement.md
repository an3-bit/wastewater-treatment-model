...
========================================================================================================================
Optimal Operating Pressures:           P1* = 20.00 bar, P2* = 20.25 bar (Boost = +0.25 bar)
Overall Water Recovery:                84.35% (84.3533%)
Maximum Element Recovery:              29.99% (29.9859% <= 30.000%, Margin = 0.0141 percentage points)
Specific Energy Consumption:           0.7938 kWh/m3 (0.793781 kWh/m3)
Permeate TDS Quality:                  9.05 mg/L (<= 18.0 mg/L reference limit)
Concentrate Salinity:                  12995.5 mg/L
Average Trans-Membrane Flux:           45.60 LMH
Maximum Polarization Modulus:          beta = 1.3590 (<= 1.40 safeguard)
Volumetric Production:                 Permeate Qp = 25.31 m3/h | Concentrate Qr = 4.69 m3/h
Electrical Power Consumption:          20.09 kW
========================================================================================================================
...
| **Strategy A (Max Feasible Recovery)** | **20.00 / 20.25 bar** | **84.35%** | **0.7938** | **29.99%** | **9.05** | **45.60** | **1.359** | **20.09** | **Refined Upper Physical Limit ($R_{\text{elem, max}} \le 30\%$)** |
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **<= 27.0%** | 18.90 | 18.90 | 80.59% | 0.7795 | 8.42 | 1.333 | 24.18 | 18.85 |
| **<= 28.0%** | 19.30 | 19.30 | 81.90% | 0.7838 | 8.62 | 1.342 | 24.57 | 19.26 |
| **<= 29.0%** | 19.80 | 19.80 | 83.44% | 0.7899 | 8.89 | 1.354 | 25.03 | 19.77 |
| **<= 30.0%** | 20.00 | 20.25 | 84.35% | 0.7938 | 9.05 | 1.359 | 25.31 | 20.09 |
...
2. **At what P1/P2 does it occur?**  
   $$P_1^* = 20.00\,\text{bar}, \quad P_2^* = 20.25\,\text{bar} \quad (\Delta P_{\text{boost}} = +0.25\,\text{bar})$$

3. **How close is max element recovery to 30%?**  
   Maximum element recovery is **29.9859%**, which is within **0.0141 percentage points** of 30.000% (well within the <= 0.05 target threshold) and strictly feasible.
...
4. **What recovery is available with 27%, 28%, 29% and 30% safeguards?**  
   ...
   - <= 30% limit: **85.08%** recovery ($P_1=20.00, P_2=20.25\,\text{bar}$, $\text{SEC}=0.7938$).
...
6. **What are the corrected four representative strategies?**  
   - **A (Max Feasible Recovery)**: 20.00 / 20.25 bar -> R = 84.35%, SEC = 0.7938 kWh/m3, MaxElemRec = 29.99%  
